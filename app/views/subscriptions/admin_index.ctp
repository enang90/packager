<div class="subscriptions index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $subscription['Subscription']['type']; ?>&nbsp;</td>
		<td><?php echo $subscription['Subscription']['amount']; ?>&nbsp;</td>
		<td><?php echo $subscription['Subscription']['term']; ?>&nbsp;</td>
		<td><?php echo $subscription['Subscription']['period']; ?>&nbsp;</td>
		<td class="actions">
